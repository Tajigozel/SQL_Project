...
--FIND OUT WHO MAKE THE LEAST AMOUNT OF MONEY IN EMPLOYEES TABLE

SELECT MIN(SALARY) FROM EMPLOYEES;

--FIND OUT THE MONTHLY TOTAL BUDGET FOR EMPLOYEES SALARY G(GET THE SUM OF ALL SALARY)

SELECT SUM(SALARY) FROM EMPLOYEES;

--FIND OUT THE AVERAGE SALARY OF ALL EMLOYEES
...
--FIND OUT MAX SALARY IN EACH DEPARTMENT
...
--FIND OUT AVERAGE OF SALARY IN EACH DEPARTMENT_ID
...
--FIND OUT FROM LOCATION TABLE, FIND OUT HOW MANY LOCATION IN EACH COUNTRY(ID)
